...
export const PROVIDER_TARGET_FIELDS: TargetField[] = [
  { key: "personal_cva", label: "Personal PVA Target", type: "decimal" },
...
export const ROLE_TARGET_GROUPS: RoleTargetGroup[] = [
  {
    ...
    cvaTierFields: [
      { key: "cva_target_new_grad", label: "PVA Target — New Grad" },
      { key: "cva_target_2_5yr", label: "PVA Target — 2-5yr" },
    ],
  },
  {
    id: "massage",
  ...
  },
  {
    ...
    fields: SHARED_CLINICIAN_TARGET_FIELDS,
    cvaTierFields: [{ key: "cva_target_senior", label: "PVA Target — Senior (6+yr)" }],
  },
  {
    id: "admin",
    label: "Admin",
    ...
    fields: [
      ...
      { key: "onboarding_video_pct", label: "Onboarding Videos Sent (OBV)", type: "percent" },
