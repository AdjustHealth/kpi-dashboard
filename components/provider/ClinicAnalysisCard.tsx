  ...
  return (
    <Card title="Clinic Analysis" action={<span className="text-xs text-muted">Shared clinic-wide data</span>}>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatTile {...clinicStatTile(history, "cva_new_grads", "up", { target: 4, betterWhen: "higher" })} label="UCVA — New Grads" />
        <StatTile {...clinicStatTile(history, "cva_2_5yr", "up", { target: 6, betterWhen: "higher" })} label="UCVA — 2-5yr" />
